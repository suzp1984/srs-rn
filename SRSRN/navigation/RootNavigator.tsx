...
// TODO(tasks 3-7): uncomment as each screen lands
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        {/* TODO(tasks 3-7): uncomment Stack.Screen lines as each screen lands.
            {null} placeholder satisfies the required `children` prop while no
            screens are registered. Remove {null} when the first screen lands. */}
        {null}
